...
<div id="toc_container" class="no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#i"><span class="toc_number toc_depth_1">1</span> 一个想法</a>
    </li>
    <li>
      <a href="#HTML_Application_Cache"><span class="toc_number toc_depth_1">2</span> HTML Application Cache</a>
    </li>
    <li>
      <a href="#i-2"><span class="toc_number toc_depth_1">3</span> 一些坑</a><ul>
        <li>
          <a href="#_mime_type"><span class="toc_number toc_depth_2">3.1</span> 后缀与 mime type：</a>
        </li>
        <li>
          <a href="#i-3"><span class="toc_number toc_depth_2">3.2</span> 请注意引用缓存清单的页面：</a>
        </li>
        <li>
          <a href="#Android_PhoneGap"><span class="toc_number toc_depth_2">3.3</span> Android 下 PhoneGap 应用程序的问题：</a>
        </li>
        <li>
          <a href="#i-4"><span class="toc_number toc_depth_2">3.4</span> 跨域：</a>
        </li>
        <li>
          <a href="#_Application_Cache"><span class="toc_number toc_depth_2">3.5</span> 禁用 Application Cache：</a>
        </li>
        <li>
          <a href="#i-5"><span class="toc_number toc_depth_2">3.6</span> 完整更新和二次刷新：</a>
        </li>
      </ul>
    </li>
  </ul>
