...
<div id="toc_container" class="no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#i"><span class="toc_number toc_depth_1">1</span> 发现问题</a>
    </li>
    <li>
      <a href="#_async"><span class="toc_number toc_depth_1">2</span> 在事件上直接使用 async 引发的错误</a><ul>
        <li>
          <a href="#i-2"><span class="toc_number toc_depth_2">2.1</span> 代码段一：</a>
        </li>
        <li>
          <a href="#i-3"><span class="toc_number toc_depth_2">2.2</span> 代码段二：</a>
        </li>
      </ul>
    </li>
    
    <li>
      <a href="#UseTaskFriendlySynchronizationContext"><span class="toc_number toc_depth_1">3</span> UseTaskFriendlySynchronizationContext 的作用和错误引发的原因</a><ul>
        <li>
          <a href="#UseTaskFriendlySynchronizationContext-2"><span class="toc_number toc_depth_2">3.1</span> UseTaskFriendlySynchronizationContext 的作用：</a>
        </li>
        <li>
          <a href="#i-4"><span class="toc_number toc_depth_2">3.2</span> 引发错误的原因：</a>
        </li>
      </ul>
    </li>
    
    <li>
      <a href="#i-5"><span class="toc_number toc_depth_1">4</span> 目前正确的写法</a><ul>
        <li>
          <a href="#i-6"><span class="toc_number toc_depth_2">4.1</span> 参考资料：</a>
        </li>
      </ul>
    </li>
  </ul>
...
在我的上一篇文章<a href="http://www.dozer.cc/2012/03/async-and-await-in-web-application/" target="_blank"><strong>《async 与 await 在 Web 下的应用》</strong></a>中，我提到了 asp.net 4.5 在 Web.Config 中的一个奇怪配置：
